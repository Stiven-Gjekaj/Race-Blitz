...
export function renderRaceResult(){
  ...
  const rows = rr.order.map((id,idx)=> h('tr',{}, h('td',{}, 'P'+(idx+1)), h('td',{}, id), h('td',{}, fmt.time(rr.times[id]||0)), h('td',{}, rr.fastestLap.carId===id?'FL':''), h('td',{}, rr.points.get? (rr.points.get(id)||0) : (rr.points[id]||0))));
